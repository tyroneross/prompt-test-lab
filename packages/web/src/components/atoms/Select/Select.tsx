 ...
 * 
 * A customizable select dropdown component with proper accessibility
 * and Calm Precision design tokens.
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'dark:border-gray-700 dark:bg-gray-950 dark:ring-offset-gray-950 dark:placeholder:text-gray-400 dark:focus:ring-blue-400',
      className
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'dark:focus:bg-blue-900 dark:focus:text-blue-50',
      className
    )}
    {...props}
  >
